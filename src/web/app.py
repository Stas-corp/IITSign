...
class StreamlitApp:
            ...
            st.markdown("""
                ...
                - #### Для підпису пакету документів треба передати шлях до папки
                    ...
                    - #### Приклад:
                        ...
                        - Повний шлях до папки `C:\\Users\\ssamo\\Documents\\Projects\\Ace_11_09_2025_part1`
                        
                        - то в поле `Введіть шлях до локальної папки з документами` треба вставити тільки `Projects\\Ace_11_09_2025_part1`
                    
                    - Якщо в середині паки є інші папки - программ пройде по всім файлам в середині цих папко і буде підписувати все що знайде з розширенням `.pdf`
    ...
    def dell_signs(self):
        if ("root_folder" in st.session_state and st.session_state.root_folder != ""):
